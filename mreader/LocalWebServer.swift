...
final class LocalWebServer: ObservableObject {
    ...
    private let allowedUploadExtensions: Set<String> = ["zip", "cbz", "pdf", "jpg", "jpeg", "png", "webp", "heic", "heif"]
    ...
    private func uploadPage() -> String {
        ...
        <input name="file" type="file" accept=".zip,.cbz,.pdf,.jpg,.jpeg,.png,.webp,.heic,.heif" required>
